...
from opening.opening_buysell_trade import OpeningBuySell
...
def task():
    ...
    schedule.every().day.at("14:46:05").do(OpeningBuySell.main_task)

    while True:
        print("schedule opening buy sell job  - run pending ... ")
